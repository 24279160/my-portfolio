...
const App = () => {
  ...
  // --- 英雄區成果模組：優化為三項佈局 ---
  const impactModules = [
    { label: "Search Success", value: "+20%", icon: Zap, desc: "規劃自然語言搜尋（Deep Search）介面與功能，有效解決搜尋摩擦。" },
    { label: "Conversion Rate", value: "+10-15%", icon: TrendingUp, desc: "與高層規劃商品化策略 Landing Page，大幅驅動內容銷售轉換。" },
    { label: "XR System", value: "$40M", icon: Cpu, desc: "主導 0→1 大型政府 XR 訓練專案落地，精準管理複雜技術規格驗收。" }
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      results: ['完成 4,000 萬標案驗收，成功導入教學體系', '成功將研究洞察轉化為優先級決策'],
      icon: ShieldCheck, 
    ...
    },
    {
      ...
      ctas: [
        ...
        { label: 'PROTOTYPE', url: 'https://www.figma.com/proto/Zqj906uj1rMQpcvOwg24LE/BUS--UI?page-id=138%3A1498&node-id=710-73139&viewport=-9828%2C1631%2C0.35&t=OsYzfvX2xK1TiOQ2-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=710%3A73139&show-proto-sidebar=1', icon: <Navigation size={14} /> }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans relative cursor-none overflow-x-hidden">
      ...
      <footer id="about" className="py-32 px-6 bg-white text-center border-t border-slate-100">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-24 text-[10px] font-black text-slate-300 tracking-[0.8em] uppercase">© 2026 JEN-HAO ZHENG · PM PORTFOLIO V15.4 FINAL</div>
        </div>
      </footer>
    </div>
  );
